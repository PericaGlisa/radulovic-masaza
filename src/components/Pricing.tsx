...
const plans = [
  {
    ...
    duration: "60 min",
    price: "6.500",
    desc: "Kratak, ali moćan ritual za one koji žele predah od svakodnevice.",
    features: ["Konsultacija (10 min)", "Manuelna terapija po izboru", "Topla aromaterapija", "Trenutak tišine sa čajem"],
    featured: false,
  },
  {
    name: "Signature",
    duration: "90 min",
    price: "9.900",
    desc: "Autorski wellness ritual — najtraženije iskustvo u studiju.",
    features: ["Detaljna konsultacija", "Kombinacija dve tehnike", "Vrući kamenovi & ulja", "Holistički završetak", "Personalizovane preporuke"],
    featured: true,
  },
  {
    name: "Sanctuary",
    duration: "120 min",
    price: "14.500",
    desc: "Potpuno potapanje — vreme zaustavljeno, telo i um obnovljeni.",
    features: ["Privatna atmosfera", "Tri integrisane tehnike", "Aromaterapija + kamenovi", "Ritual kupke", "Posttretmanski razgovor"],
    featured: false,
  },
];
